...
public class OthersFragment extends Fragment implements ImageView.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Glide.with(mainContext).load(R.drawable.poker).into(img[0]);
        Glide.with(mainContext).load(R.drawable.brainvista).into(img[1]);
        Glide.with(mainContext).load(R.drawable.bgx).into(img[2]);
        Glide.with(mainContext).load(R.drawable.qfiesta).into(img[3]);
    ...
    public void onClick(View view) {
        ...
        switch (j) {
            case 0:
                title.setText("Poker");
                rules.setText(getString(R.string.poker));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_poker)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 1:
                title.setText("Brainvista");
                rules.setText(getString(R.string.brain_vista));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_brainvista)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 2:
                ...
                title.setText("Battle Ground-X");
                rules.setText(getString(R.string.battle_ground));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_battle_ground)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 3:
                title.setText("Q-Fiesta");
                rules.setText(getString(R.string.qfiesta));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_Qfiesta)));
                        startActivity(viewIntent);
                    }
                });
