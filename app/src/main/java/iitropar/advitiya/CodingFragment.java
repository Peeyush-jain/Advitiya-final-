...
public class CodingFragment extends Fragment implements ImageView.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Glide.with(mainContext).load(R.drawable.hackamania).into(img[0]);
        Glide.with(mainContext).load(R.drawable.makethon).into(img[1]);
        Glide.with(mainContext).load(R.drawable.pnp).into(img[2]);
    ...
    public void onClick(View view) {
        ...
        switch (j) {
            case 0:
                title.setText("Hackamania");
                rules.setText(getString(R.string.hackamania));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_hackamania)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 1:
                title.setText("Make-Thon");
                rules.setText(getString(R.string.makethon));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_makethon)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 2:
                ...
                title.setText("P=NP");
                rules.setText(getString(R.string.pnp));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_pnp)));
                        startActivity(viewIntent);
                    }
                });
                break;
