...
public class EngineeringFragment extends Fragment implements ImageView.OnClickListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Glide.with(mainContext).load(R.drawable.young).into(img[0]);
        Glide.with(mainContext).load(R.drawable.design).into(img[1]);
        Glide.with(mainContext).load(R.drawable.onehm).into(img[2]);
        Glide.with(mainContext).load(R.drawable.flight_show).into(img[3]);
        Glide.with(mainContext).load(R.drawable.waterrocket).into(img[4]);
    ...
    public void onClick(View view) {
        ...
        switch (j) {
            case 0:
                title.setText("Young Scientist");
                rules.setText(getString(R.string.young_scientist));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_young_scientist)));
                        startActivity(viewIntent);
                    }
                });
                break;
            case 1:
                title.setText("Design and Simulate");
                rules.setText(getString(R.string.design_simulate));

                more.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View arg0) {
                            Intent viewIntent =
                                    new Intent("android.intent.action.VIEW",
                                            Uri.parse(getString(R.string.register_design_simulate)));
                            startActivity(viewIntent);
                        }
                    });
                break;
            case 2:
                    ...
                    title.setText("One Ohm");
                    rules.setText(getString(R.string.one_ohm));

                    more.setOnClickListener(new View.OnClickListener() {
                        public void onClick(View arg0) {
                            Intent viewIntent =
                                    new Intent("android.intent.action.VIEW",
                                            Uri.parse(getString(R.string.register_one_ohm)));
                            startActivity(viewIntent);
                        }
                    });
                break;
            case 3:
                title.setText("Flight Show");
                rules.setText(getString(R.string.flight_show));

               more.setOnClickListener(new View.OnClickListener() {
                   public void onClick(View arg0) {
                        Intent viewIntent =
                               new Intent("android.intent.action.VIEW",
                                       Uri.parse(getString(R.string.register_flight_show)));
                       startActivity(viewIntent);
                   }
             });
                ...
                break;
            case 4:
                title.setText("Water Rocket");
                rules.setText(getString(R.string.water_rocket));

                more.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View arg0) {
                        Intent viewIntent =
                                new Intent("android.intent.action.VIEW",
                                        Uri.parse(getString(R.string.register_water_rocket)));
                        startActivity(viewIntent);
                    }
                });
                break;
